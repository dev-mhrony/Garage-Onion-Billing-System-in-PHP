                                            ...
                                            <div class="row">
                                              ...
                                              <label class="col-sm-2 control-label">Mechanic Name</label>
                                               <div class="col-sm-4">
                                                ...
                                                <input type="text" name="mname" class="form-control" placeholder="" autocomplete="off" value="<?php echo $data['mechanicname'] ?>"  required/>
                                               </div>


                                                <label class="col-sm-2 control-label">Supervisor Name</label>
                                                <div class="col-sm-4">
                                                 <input type="text" class="form-control" id="orderDate" name="sname" autocomplete="off" value="<?php echo $data['supervisor_name'] ?>" />
                                               </div>
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            ...
                                            <div class="row">
                                              ...
                                              <label class="col-sm-2 control-label"> Delivery Date</label>
                                               <div class="col-sm-4">
                                                ...
                                                <input type="date" name="deliverydate" class="form-control" placeholder="" autocomplete="off" value="<?php echo $data['delivery_date'] ?>"  required/>
                                               </div>


                                                <label class="col-sm-2 control-label">Delivery Time </label>
                                                <div class="col-sm-4">
                                                 <input type="time" class="form-control" id="orderDate" name="deliverytime" value="<?php echo $data['delivery_time'] ?>" autocomplete="off" />
                                               </div>
                                            </div>
                                        </div>     
