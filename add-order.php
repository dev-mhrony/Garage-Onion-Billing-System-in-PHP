                                            ...
                                            <div class="row">
                                              ...
                                              <label class="col-sm-2 control-label">Mechanic Name</label>
                                               <div class="col-sm-4">
                                                ...
                                                <input type="text" name="mname" class="form-control" placeholder="" autocomplete="off"  required/>
                                               </div>
                                            ...
                                            <div class="row">
                                              ...
                                              <label class="col-sm-2 control-label"> Delivery Date</label>
                                               <div class="col-sm-4">
                                                ...
                                                <input type="date" name="deliverydate" class="form-control" placeholder="" autocomplete="off"  required/>
                                               </div>


                                                <label class="col-sm-2 control-label">Delivery Time </label>
                                                <div class="col-sm-4">
                                                 <input type="time" class="form-control" id="orderDate" name="deliverytime" autocomplete="off" />
                                               </div>
                                            </div>
                                        </div>
